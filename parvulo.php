...
<a href="equipo.php"  class="nav-enlace" >Equipo de Trabajo</a>
 ...
 require("config.php");
  ...
  $sqlVideo   = ("SELECT * FROM videos where id=13");
    ...
    <div class="container">
     ...
     <hr>
      ...
      <div class="row text-center">
        ...
        <h5>La belleza del universo no es solo la UNIDAD de la variedad, sino tambien la diversidad en la unidad.</h5>
      </div>
    </div>
...
?>
 ...
 require("config.php");
  ...
  $sqlVideo   = ("SELECT * FROM videos where id=25");
  $queryVideo = mysqli_query($con, $sqlVideo);
  $totalVideo = mysqli_num_rows($queryVideo);
  $DataVideo  = mysqli_fetch_array($queryVideo);
?>
