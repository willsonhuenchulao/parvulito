...
<body>
  ...
  <div class="container mt-5 pd-5">
    ...
    <div class="form-group">
      <label for="urlVideo">Pegar URL del Video Para Etapa de Parvulos.. <em>(Desde Youtube)</em></label>
      <input type="text" name="urlVideo" class="form-control">
    </div>

    <div class="form-group">
      <label for="urlVideo">Pegar URL del Video Etapa de Pre-Basíca<em>(Desde Youtube)</em></label>
      <input type="text" name="urlVideo" class="form-control">
    </div>
    ...
    <table class="table table-hover table-striped">
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            <a href="agregarVideo.php?idVideo=<?php echo $dataVideo['id']; ?>" class="btn btn-danger">Crear Video</a>
          </td>
          <td>
            <a href="BorrarVideoYoutube.php?idVideo=<?php echo $dataVideo['id']; ?>" class="btn btn-danger" onclick="return confirm('Estás seguro que deseas eliminar el Video?');">Borrar video</a>
          </td>
        </tr>
      <?php } ?>
      </tbody>
