...
<a href="parvulo.php" class="nav-enlace">Parvulo</a>
...
<a href="equipo.php"  class="nav-enlace" >Equipo de Trabajo</a>
 ...
 require("config.php");
  ...
  $sqlVideo   = ("SELECT * FROM videos where id=28");
...
Ingeniero Informático  capacitado para organizar y dirigir el área de Sistemas de todo tipo de Organizaciones, así como para planificar, dirigir, relevar, analizar, diseñar, desarrollar e implementar proyectos de integración de Software, de e-business, de telecomunicaciones y redes y, en general, todo proyecto.</p>

</div>
</center>
<center>
<div class="col-6 text-center">
          <img class="img-fluid" src="equipo.jpg" alt="">
        </div>
        </center>
